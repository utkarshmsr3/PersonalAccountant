...
public class CashBook {
	...
	int userId;
	String operation;
	public CashBook(int acId, String account, Date tranDate, double amount, int userId, String operation) {
		super();
		this.acId = acId;
	...
	public String toString() {
		return "CashBook [acId=" + acId + ", account=" + account + ", tranDate=" + tranDate + ", amount=" + amount

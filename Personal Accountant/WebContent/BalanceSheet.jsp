...
<html lang="en">
  <head>
    ...
    <title>Personal Accountant - Balance Sheet</title>
  ...
  <body>  
        ...
        <nav class="templatemo-left-nav">          
          <ul>
				...
				<li><a href="DayBookController"><i class="fa fa-sun-o fa-fw"></i>Day
						Book</a></li>
				<li><a href="BalanceSheetController" class="active"><i class="fa fa-database fa-fw"></i>Balance
						Sheet</a></li>
	...
	<div class="templatemo-content-widget no-padding">
            <div class="panel panel-default table-responsive">
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
		  <tr><td colspan="3"><h2 class="text-center">BALANCE SHEET</h2></td></tr>
                  <tr>
                  <form action="BalanceSheetController">
                    <td><label for="dateFrom">Date From</label><br><input type="date" name="dateFrom" id="dateFrom" required></td>
                    <td><label for="dateTo">To</label><br><input type="date" name="dateTo" id="dateTo" required></td>
                    <td><input type="submit" class="templatemo-edit-btn" value="Show"></a></td>
                  </tr>
                </thead>
		<tbody>
		</tbody>
	...
	<div class="templatemo-content-widget no-padding">
            <div class="panel panel-default table-responsive">
				${requestScope.bsTableData} 
            </div>                          
          </div> 

          <footer class="text-right">
            <p>Copyright &copy; 2018 UT 
            | Designed by Utkarsh Mishra</p>
          </footer>
        </div>
       </div>
	</div>

...
<html lang="en">
  <head>
    ...
    <title>Personal Accountant - Day Book</title>
        ...
        <nav class="templatemo-left-nav">          
          <ul>
				...
				<li><a href="BankBookController"><i class="fa fa-university fa-fw"></i>Bank
						Book</a></li>
				<li><a href="DayBookController" class="active"><i class="fa fa-sun-o fa-fw"></i>Day
						Book</a></li>
	...
	<div class="templatemo-content-widget no-padding">
            <div class="panel panel-default table-responsive">
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
		    <td><h2 class="text-center">Day Book</h2></td>
		    <form action="DayBookController">
                    <td colspan="2"><label for="dateFrom">Date From</label><br><input type="date" name="dateFrom" id="dateFrom" required></td>
                    <td colspan="2"><label for="dateTo">To</label><br><input type="date" name="dateTo" id="dateTo" required></td>

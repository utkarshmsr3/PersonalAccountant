...
<title>Personal Accountant - Income Category</title>
	...
	<div class="templatemo-flex-row">
		<div class="templatemo-sidebar">
			...
			<ul>
				...
				<li><a href="IncomeCategoryController" class="active"><i
		...
		${requestScope.incomeCategoryNotification}
			<br> <br> <br>
			<script>
				function createAction(){
					window.alert("in create");
					document.getElementById("incomeCategoryOperationCreate").value = "create";
					window.alert("returning true:create");
					return true;
				}
			</script>
			<form action="IncomeCategoryController" onsubmit="return createAction();" class="templatemo-login-form" method="post">
				<input type="hidden" id="incomeCategoryOperationCreate" name="incomeCategoryOperationCreate">
			...
			<div class="templatemo-content-widget no-padding">
				...
				<script>
					...
					function deleteAction(catid){
						document.getElementById("incomeCategoryOperation").value = "delete";
					...
					function saveAction(catid){
						...
						document.getElementById("incomeCategoryOperation").value = "save";
					...
					<form action="IncomeCategoryController" id="tableForm" method="post">
						<input type="hidden" id="incomeCategoryOperation" name="incomeCategoryOperation">
						...
						${requestScope.incomeCategoryData}
					</form>
				</div>
			</div>
		</div>

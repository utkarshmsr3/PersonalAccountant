...
<title>Personal Accountant - Expense</title>
...
<body>
	...
	<div class="templatemo-flex-row">
		<div class="templatemo-sidebar">
			...
			<ul>
				...
				<li><a href="ExpenseController" class="active"><i class="fa fa-dollar fa-fw"></i>Expense</a></li>
		...
		${requestScope.ExpenseMessage}
			<div class="templatemo-content-container">
				<div class="templatemo-content-widget white-bg">
					<h2 class="margin-bottom-10">Expense</h2>
					<br> <br>
					<form action="ExpenseController" onsubmit="return submitForm();"
						class="templatemo-login-form" method="post">
						<div class="row form-group">
							<div class="col-lg-12 col-md-6 form-group">
								<label for="inputExpenseName">Name</label> <input type="text"
									class="form-control" id="inputExpenseName"
									name="inputExpenseName" placeholder="Expense Name" required>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-lg-6 col-md-6 form-group">
								<label class="control-label templatemo-block"
									...
									name="inputExpenseCategory" id="inputExpenseCategory"
									class="form-control">
									${requestScope.expenseCategories}
								</select>
							</div>
							<div class="col-lg-6 col-md-6 form-group">
								<label class="control-label templatemo-block">Pay By</label> <select
									name="inputPayBy" class="form-control">
	...
	<script>
		...
		function submitForm() {
			...
			if (document.getElementById("inputExpenseCategory").value == "") {
				document.getElementById("inputCategoryLabel").innerHTML = "Category (* no category created)<a href=\"ExpenseCategoryController\"> Create Category !</a>";
				return false;
			}

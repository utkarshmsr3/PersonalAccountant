...
<title>Personal Accountant - CashBook</title>
	...
	<div class="templatemo-flex-row">
		...
		<div class="mobile-menu-icon">
			...
			<ul>
				...
				<li><a href="CashBookController" class="active"><i class="fa fa-book fa-fw"></i>Cash
						Book</a></li>
				...
				<div class="templatemo-content-widget no-padding">
					<div class="panel panel-default table-responsive">
						<table
							...
							<thead>
								<tr>
								<form action="CashBookController">
									<td><h2 class="text-center">Cash Book</h2></td>
							...
							${requestScope.cashBookTableData}
						</table>
					</div>
				</div>
